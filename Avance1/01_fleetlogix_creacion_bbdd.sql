...
------- ASEGURAR LA INTEGRIDAD LA CONSISTENCIA TEMPORAL -----
...
TRUNCATE TABLE deliveries, trips, maintenance, vehicles, drivers, routes, load_logs RESTART IDENTITY CASCADE;
	
------- -BORRAR LAS TABLAS --------------
DROP TABLE deliveries, trips, maintenance, vehicles, drivers, routes, load_logs;
